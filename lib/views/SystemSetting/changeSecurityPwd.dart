...
class ChangeSecurityPwd extends StatefulWidget {
  final url;

  ChangeSecurityPwd(this.url);
  @override
  _ChangeSecurityPwdState createState() => _ChangeSecurityPwdState();
}

class _ChangeSecurityPwdState extends State<ChangeSecurityPwd> {
  ...
  postData(bodyData) async {
    ...
    print(bodyData);
    var contentData = await Request().postRequest(Config().url+"api/member/change-secpassword", bodyData, token, context);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Center(
                      child: Text(
                          MyLocalizations.of(context).getData('change_security_pwd'),
                  ...
                  child: Form(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            child: Text(MyLocalizations.of(context).getData('old_sec_password'),style: TextStyle(color: Colors.white,fontSize: 16),),
                          ),
                          SizedBox(height: 5.0),
                          _inputOldPassword(),
                          SizedBox(height: 20.0),
                          ...
                          Container(
                            child: Text(MyLocalizations.of(context).getData('new_sec_password'),style: TextStyle(color: Colors.white,fontSize: 16),),
                          ),
                          SizedBox(height: 5.0),
                          _inputPassword(),
                          SizedBox(height: 20.0),
                          ...
                          Container(
                            child: Text(MyLocalizations.of(context).getData('confirm_sec_new_password'),style: TextStyle(color: Colors.white,fontSize: 16),),
                          ),
                          SizedBox(height: 5.0),
  ...
  _sendToServer() {
    if (_key.currentState.validate()) {
      ...
      if (mounted)
        setState(() {
          tmap['sec_password'] = _oldpasswordController.text;
