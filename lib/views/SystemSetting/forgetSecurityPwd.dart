...
class ForgetSecurityPwd extends StatefulWidget {
  final url;

  ForgetSecurityPwd(this.url);
  @override
  _ForgetSecurityPwdState createState() => _ForgetSecurityPwdState();
}

class _ForgetSecurityPwdState extends State<ForgetSecurityPwd> {
  ...
  postData(bodyData) async {
    ...
    print(bodyData);
    var contentData = await Request().postRequest(Config().url+"api/member/reset-secpassword", bodyData, token, context);
