...
class ApiBindingOtp extends StatefulWidget {
  final url;
  final type;

  ApiBindingOtp(this.url,this.type);
  @override
  _ApiBindingOtpState createState() => _ApiBindingOtpState();
}

class _ApiBindingOtpState extends State<ApiBindingOtp>
      ...
      if (contentData['code'] == 0) {
        ...
        onDissmissCallback: () {
           Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => ApiBindingForm( widget.url, widget.type)));
        })
      ..show();
    } else {
