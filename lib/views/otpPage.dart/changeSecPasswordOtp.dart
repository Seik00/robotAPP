...
class ChangeSecPasswordOtp extends StatefulWidget {
  final url;

  ChangeSecPasswordOtp(this.url);
  @override
  _ChangeSecPasswordOtpState createState() => _ChangeSecPasswordOtpState();
}

class _ChangeSecPasswordOtpState extends State<ChangeSecPasswordOtp>
