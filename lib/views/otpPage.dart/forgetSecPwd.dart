...
import 'package:robot/views/SystemSetting/forgetSecurityPwd.dart';
import '../../vendor/i18n/localizations.dart' show MyLocalizations;
import 'package:shared_preferences/shared_preferences.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'package:http/http.dart' as http;

class ForgetSecPwdOtp extends StatefulWidget {
  final url;

  ForgetSecPwdOtp(this.url);
  @override
  _ForgetSecPwdOtpState createState() => _ForgetSecPwdOtpState();
}

class _ForgetSecPwdOtpState extends State<ForgetSecPwdOtp>
      ...
      if (contentData['code'] == 0) {
        ...
        onDissmissCallback: () {
           Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => ForgetSecurityPwd( widget.url)));
        })
      ..show();
    } else {
